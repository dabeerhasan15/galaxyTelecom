...
export const Header = () => {
  ...
  const openContactModal = () => {
    setIsContactOpen(true);
    setIsMobileMenuOpen(false); // Close mobile menu when opening contact
  };
...
// Export a hook to programmatically open the contact modal from other components
export const useContactModal = () => {
  const openContact = () => {
    // Trigger custom event that the Header component can listen to
