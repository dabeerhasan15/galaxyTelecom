...
export const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setIsScrolled(window.scrollY > 10); // threshold
    };
  ...
  const linkClass = (path: string) =>
    ...
    `${styles.link} ${activeLink === path ? styles.active : ""}`;
        ...
        <>
          ...
          <div className={styles.contactModal}>
            ...
            >
              ...
              >
                <path
                  d="M24.9902 6.00638L7.0081 23.9885"
                  stroke="black"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                    ...
                    <div className={styles.flexgap}>
                      <div className={styles.modalHeader}>
                        ...
                        <p className={styles.modalDescription}>
                          Have questions ready to get started? Our sales
                          <br />
                      ...
                      <div className={styles.flexx}>
                        ...
                        <div className={styles.socialLinks}>
                          ...
                          <a href="#" aria-label="Twitter">
                            ...
                            >
                              <path
                                d="M17.7299 3H20.7834L14.1124 10.6246L21.9604 21H15.8154L11.0025 14.7074L5.49548 21H2.4401L9.57549 12.8446L2.04688 3H8.34779L12.6982 8.75169L17.7299 3ZM16.6582 19.1723H18.3502L7.42841 4.73169H5.61271L16.6582 19.1723Z"
                                fill="#1F1F1F"
                              />
                            </svg>
                          </a>
