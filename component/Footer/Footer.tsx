              ...
              <div className="col-lg-5">
                <div className={classes.contactUs}>
                  <div>
                    ...
                    <Space/>
                    <div className={classes.number}>+971-4-2780986</div>
                    <div className={classes.number}>info@galaxy-telecom.com</div>
                  </div>

                  <div>
                  <div className={classes.contact}>PP.O. Box</div>
                    <Space/>
                    <div className={classes.ppo}>74302</div>
                  </div>

                  <div>
                  <div className={classes.contact}>Location</div>
                    <Space/>
                    <div className={classes.number}> Office: 407-1, B Block, HQ Building,
                    </div>
                    <div className={classes.number}>
                      Dubai Silicon Oasis, Dubai - UAE.</div>
                  </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-2">
                <div className={classes.images}>
                  ...
                  <div className={classes.social}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17.7299 3H20.7834L14.1124 10.6246L21.9604 21H15.8154L11.0025 14.7074L5.49548 21H2.4401L9.57549 12.8446L2.04688 3H8.34779L12.6982 8.75169L17.7299 3ZM16.6582 19.1723H18.3502L7.42841 4.73169H5.61271L16.6582 19.1723Z" fill="white"/>
                  </svg>
