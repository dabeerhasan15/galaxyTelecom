            ...
            <div className="col-lg-7">
              <div className={classes.content}>
                ...
                <div className={classes.context}>
                  ...
                  Maritime / Government & Humanitarian Agencies. Taking
                  advantage of the rich experience of its team members, Galaxy
                  Telecom is a distinguished and recognized leader in the
          ...
          <div className="row">
            <div className="col-lg-7">
              <div className={classes.contents}>
                <div className={classes.tag}>Our belief</div>
                <Space size={componentSizes.large} />
                <Space size={componentSizes.large} />
                <div className={classes.heading}>Values & Code of Ethics</div>
                <Space />
                <Space />
                <div className={classes.context}>
                  Ethical behavior has less to do with what may be required by
                  ...
                  because it is the right thing to do. Galaxy Telecom’s goal is
                  not solely to comply with the laws that affect our business,
                  but to abide by the highest level of ethical conduct in our
                  business affairs. We place the utmost importance upon our
                  reputation for honesty, integrity, and high standards.
                </div>
              </div>
            </div>
